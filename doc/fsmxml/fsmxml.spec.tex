...
\paragraph*{Children}
\children{
  \child{labelGen}{A label set generator.}{Occurs 1 or more
    times.}{labelGen}
}
...
\subsubsection*{Children}
\children{
  \child{labelSet}{A \texttt{free} label set.}{Occurs \xval{prodDim}
    times.}{free label set}
}
...
Represents a label set element, which is a concatenation of label set
generators.
...
\paragraph*{Children}
\children{
\item \xtag{monElmt} or \xtag{one} A label set element or the identity
