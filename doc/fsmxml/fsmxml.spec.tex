...
\subsubsection*{Children}
\children{
  \child{writingData}{Representation data.}{Occurs 0 or 1
    time.}{writingDataMonoid}
}
...
\subsubsection*{Children}
\children{
  \child{geometricData}{The automaton's geometry data.}
	{Occurs 0 or 1 time.}{geometricDataAutomaton}
  \child{drawingData}{The automaton's drawing data.}
	{Occurs 0 or 1 time.}{drawingData}
...
\attrs{
  ...
  %attr{drawingclass}{}{string}{none}{}{Associate to a drawing class. See
   % \autoref{drawingclass} for more details.}
}
\subsubsection*{Children}
\children{
  \child{geometricData}{Adds geometry data.}{Occurs 0 or 1
    time.}{geometricDataState}
  \child{drawingData}{Adds drawing data.}{Occurs 0 or 1 time.}{drawingData}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Automaton's optional properties}

\subsection{\xtag{writingData}}

Stores informations that might be useful for input / output.

\subsubsection{for monoid}
\label{writingDataMonoid}

\subsubsection*{Attributes}
\attrs{
  \attr{identitySymbol}{}{string}{}{}
       {How to display the monoid identity.}
}
\subsubsection*{Children}
None.

\subsubsection{for semiring}
\label{writingDataSemiring}

\subsubsection*{Attributes}
\attrs{
  \attr{identitySymbol}{}{string}{}{}
       {How to display the semiring identity.}
  \attr{zeroSymbol}{}{string}{}{}
       {How to display the semiring zero.}
}
\subsubsection*{Children}
None.

\subsection{\xtag{geometricData}}
\label{geometricData}

Stores informations on geometric representation.

\subsubsection{for the automaton}
\label{geometricDataAutomaton}
...
\subsubsection{for states}
\label{geometricDataState}
...
\subsubsection{for the transitions}
\label{geometricDataTransition}

\subsubsection*{Attributes}
\attrs{
  \attr{TransitionType}{Pivot}{token}{none}{``EdgeL'', ``EdgeR'', ``ArcL'', ``ArcR'', ``Loop''}
       {The type of the transition.}
  \attr{loopDir}{}{integer}{}{Between 0 and 360}
       {Only available if ``Loop'' is set. The angle of the loop direction.}
  \attr{labelPos}{}{float}{}{Between 0 and 100}
       {Position of the label on the arrow. 0 is the source, 100 the target.}
  \attr{labelDist}{}{float}{}{Greater than 0}
       {Distance between the arrow and the label.}
}
\subsubsection*{Children}
None.

\subsubsection{for initial states}
\label{geometricDataInitial}

\subsubsection*{Attributes}
\attrs{
  \attr{initialDir}{}{integer}{}{Between 0 and 360}
...
\subsubsection{for final states}
\label{geometricDataFinal}

\subsubsection*{Attributes}
\attrs{
  \attr{finalDir}{}{integer}{}{Between 0 and 360}
       {The angle of the output arrow.}
  \attr{finalMod}{}{token}{}{``circle'',``arrow''}
