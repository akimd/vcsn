...
% Add Contents to the PDF bookmarks, but not as an entry within the table of
% contents itself, which would look silly:
...
% Please keep the label chapter-right-after-getting-started at the right place!
