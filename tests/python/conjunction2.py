...
CHECK_EQ(exp, lhs.conjunction2(rhs))
...
check('<u>a(\e+<u>a(<u>a)*)', a1.conjunction2(a2))
check('<u>a(\e+<u>a(<u>a)*)', a2.conjunction2(a1))
...
check('(a+b)*', z.conjunction2(q))
check('(a+b)*', q.conjunction2(z))
check('(<2>a+<3>b)*', z.conjunction2(q, z))
check('(<1/2>a+<1/3>b)*', z.conjunction2(q, q))

check('(<0.4>a+<0.9>b)*', z.conjunction2(r))
check('(<0.4>a+<0.9>b)*', r.conjunction2(z))

check('(<0.1>a+<0.1>b)*', q.conjunction2(r))
check('(<0.1>a+<0.1>b)*', r.conjunction2(q))
...
check_enumerate('<uxvy>ab', a1.conjunction2(a2))
check_enumerate('\z', a1.transpose().conjunction2(a2))
check_enumerate('\z', a1.conjunction2(a2.transpose()))
check_enumerate('<vyux>ba', a1.transpose().conjunction2(a2.transpose()))
...
check_enumerate('<abcd>x', a['a'].conjunction2(a['b'], a['c'], a['d']))
...
res = r'''digraph
{
  ...
  {
    node [shape = circle, style = rounded, width = 0.5]
    0 [label = "6, 6, 0", shape = box]
    1 [label = "0, 6, 0", shape = box]
    2 [label = "7, 6, 0", shape = box]
    3 [label = "2, 6, 0", shape = box, color = DimGray]
    4 [label = "4, 6, 0", shape = box]
    5 [label = "7, 0, 1", shape = box, color = DimGray]
    6 [label = "7, 7, 1", shape = box]
    7 [label = "2, 0, 1", shape = box, color = DimGray]
    8 [label = "2, 7, 1", shape = box, color = DimGray]
    9 [label = "4, 0, 1", shape = box]
    10 [label = "4, 7, 1", shape = box, color = DimGray]
    11 [label = "7, 2, 1", shape = box, color = DimGray]
    12 [label = "7, 4, 1", shape = box, color = DimGray]
    13 [label = "2, 2, 1", shape = box, color = DimGray]
    14 [label = "2, 4, 1", shape = box, color = DimGray]
    15 [label = "4, 2, 1", shape = box]
    16 [label = "4, 4, 1", shape = box, color = DimGray]
    17 [label = "5, 3, 0", shape = box]
    18 [label = "1, 3, 0", shape = box]
    19 [label = "7, 3, 0", shape = box]
    20 [label = "0, 3, 0", shape = box]
    21 [label = "7, 1, 1", shape = box]
    22 [label = "2, 3, 0", shape = box, color = DimGray]
    23 [label = "4, 3, 0", shape = box]
    24 [label = "2, 1, 1", shape = box, color = DimGray]
    25 [label = "4, 1, 1", shape = box]
  }
  I0 -> 0
  0 -> 1 [label = "\\e"]
  0 -> 2 [label = "\\e"]
...
CHECK_EQ(res, lhs.conjunction2(rhs))
...
res = r'''digraph
{
  ...
  {
    node [shape = circle, style = rounded, width = 0.5]
    0 [label = "6, 6, 8, 0", shape = box]
    1 [label = "0, 6, 8, 0", shape = box]
    2 [label = "7, 6, 8, 0", shape = box]
    3 [label = "2, 6, 8, 0", shape = box, color = DimGray]
    4 [label = "4, 6, 8, 0", shape = box]
    5 [label = "7, 0, 8, 1", shape = box, color = DimGray]
    6 [label = "7, 7, 8, 1", shape = box]
    7 [label = "2, 0, 8, 1", shape = box, color = DimGray]
    8 [label = "2, 7, 8, 1", shape = box, color = DimGray]
    9 [label = "4, 0, 8, 1", shape = box]
    10 [label = "4, 7, 8, 1", shape = box, color = DimGray]
    11 [label = "7, 2, 8, 1", shape = box, color = DimGray]
    12 [label = "7, 4, 8, 1", shape = box, color = DimGray]
    13 [label = "7, 7, 0, 2", shape = box, color = DimGray]
    14 [label = "7, 7, 9, 2", shape = box]
    15 [label = "2, 2, 8, 1", shape = box, color = DimGray]
    16 [label = "2, 4, 8, 1", shape = box, color = DimGray]
    17 [label = "2, 7, 0, 2", shape = box, color = DimGray]
    18 [label = "2, 7, 9, 2", shape = box, color = DimGray]
    19 [label = "4, 2, 8, 1", shape = box]
    20 [label = "4, 4, 8, 1", shape = box, color = DimGray]
    21 [label = "4, 7, 0, 2", shape = box, color = DimGray]
    22 [label = "4, 7, 9, 2", shape = box, color = DimGray]
    23 [label = "7, 2, 0, 2", shape = box, color = DimGray]
    24 [label = "7, 2, 9, 2", shape = box, color = DimGray]
    25 [label = "7, 4, 0, 2", shape = box, color = DimGray]
    26 [label = "7, 4, 9, 2", shape = box, color = DimGray]
    27 [label = "7, 7, 2, 2", shape = box, color = DimGray]
    28 [label = "7, 7, 4, 2", shape = box, color = DimGray]
    29 [label = "7, 7, 6, 2", shape = box, color = DimGray]
    30 [label = "2, 2, 0, 2", shape = box, color = DimGray]
    31 [label = "2, 2, 9, 2", shape = box, color = DimGray]
    32 [label = "2, 4, 0, 2", shape = box, color = DimGray]
    33 [label = "2, 4, 9, 2", shape = box, color = DimGray]
    34 [label = "2, 7, 2, 2", shape = box, color = DimGray]
    35 [label = "2, 7, 4, 2", shape = box, color = DimGray]
    36 [label = "2, 7, 6, 2", shape = box, color = DimGray]
    37 [label = "4, 2, 0, 2", shape = box]
    38 [label = "4, 2, 9, 2", shape = box, color = DimGray]
    39 [label = "4, 4, 0, 2", shape = box, color = DimGray]
    40 [label = "4, 4, 9, 2", shape = box, color = DimGray]
    41 [label = "4, 7, 2, 2", shape = box, color = DimGray]
    42 [label = "4, 7, 4, 2", shape = box, color = DimGray]
    43 [label = "4, 7, 6, 2", shape = box, color = DimGray]
    44 [label = "7, 2, 2, 2", shape = box, color = DimGray]
    45 [label = "7, 2, 4, 2", shape = box, color = DimGray]
    46 [label = "7, 2, 6, 2", shape = box, color = DimGray]
    47 [label = "7, 4, 2, 2", shape = box, color = DimGray]
    48 [label = "7, 4, 4, 2", shape = box, color = DimGray]
    49 [label = "7, 4, 6, 2", shape = box, color = DimGray]
    50 [label = "2, 2, 2, 2", shape = box, color = DimGray]
    51 [label = "2, 2, 4, 2", shape = box, color = DimGray]
    52 [label = "2, 2, 6, 2", shape = box, color = DimGray]
    53 [label = "2, 4, 2, 2", shape = box, color = DimGray]
    54 [label = "2, 4, 4, 2", shape = box, color = DimGray]
    55 [label = "2, 4, 6, 2", shape = box, color = DimGray]
    56 [label = "4, 2, 2, 2", shape = box]
    57 [label = "4, 2, 4, 2", shape = box, color = DimGray]
    58 [label = "4, 2, 6, 2", shape = box, color = DimGray]
    59 [label = "4, 4, 2, 2", shape = box, color = DimGray]
    60 [label = "4, 4, 4, 2", shape = box, color = DimGray]
    61 [label = "4, 4, 6, 2", shape = box, color = DimGray]
    62 [label = "5, 3, 3, 0", shape = box]
    63 [label = "1, 3, 3, 0", shape = box]
    64 [label = "7, 3, 3, 0", shape = box]
    65 [label = "0, 3, 3, 0", shape = box]
    66 [label = "7, 1, 3, 1", shape = box]
    67 [label = "2, 3, 3, 0", shape = box, color = DimGray]
    68 [label = "4, 3, 3, 0", shape = box]
    69 [label = "7, 7, 3, 1", shape = box]
    70 [label = "7, 0, 3, 1", shape = box, color = DimGray]
    71 [label = "2, 1, 3, 1", shape = box, color = DimGray]
    72 [label = "4, 1, 3, 1", shape = box]
    73 [label = "7, 7, 1, 2", shape = box]
    74 [label = "7, 2, 3, 1", shape = box, color = DimGray]
    75 [label = "7, 4, 3, 1", shape = box, color = DimGray]
    76 [label = "2, 7, 3, 1", shape = box, color = DimGray]
    77 [label = "2, 0, 3, 1", shape = box, color = DimGray]
    78 [label = "4, 7, 3, 1", shape = box, color = DimGray]
    79 [label = "4, 0, 3, 1", shape = box]
    80 [label = "7, 2, 1, 2", shape = box, color = DimGray]
    81 [label = "7, 4, 1, 2", shape = box, color = DimGray]
    82 [label = "2, 7, 1, 2", shape = box, color = DimGray]
    83 [label = "2, 2, 3, 1", shape = box, color = DimGray]
    84 [label = "2, 4, 3, 1", shape = box, color = DimGray]
    85 [label = "4, 7, 1, 2", shape = box, color = DimGray]
    86 [label = "4, 2, 3, 1", shape = box]
    87 [label = "4, 4, 3, 1", shape = box, color = DimGray]
    88 [label = "2, 2, 1, 2", shape = box, color = DimGray]
    89 [label = "2, 4, 1, 2", shape = box, color = DimGray]
    90 [label = "4, 2, 1, 2", shape = box]
    91 [label = "4, 4, 1, 2", shape = box, color = DimGray]
  }
  I0 -> 0
  0 -> 1 [label = "\\e"]
  0 -> 2 [label = "\\e"]
...
CHECK_EQ(res, lhs.conjunction2(rhs, third))
CHECK_EQUIV(vcsn.automaton(res),
            std('lal_char(b), b', 'b*'))
...
CHECK_EQ(res, a1.conjunction2(a2))
...
0 -> $
''')
CHECK_EQ((a.conjunction2(a)).strip(), a.conjunction2(2))
CHECK_EQUIV((a.conjunction2(a, a)).strip(), a.conjunction2(3))
...
insplit_res = r'''digraph
{
  ...
  {
    node [shape = circle, style = rounded, width = 0.5]
    0 [label = "0, 0, 0, 0", shape = box]
    1 [label = "0, 0, 0, 1", shape = box]
    2 [label = "0, 0, 0, 2", shape = box]
  }
  I0 -> 0
  0 -> F0
  0 -> 0 [label = "<1/2>\\e, a"]
...
CHECK_EQ(insplit_res, a.conjunction2(a, a))
...
res = r'''digraph
{
  ...
  }
  {
    node [shape = circle, style = rounded, width = 0.5]
    0 [label = "0, 0, 0", shape = box]
    1 [label = "2, 0, 0", shape = box, color = DimGray]
    2 [label = "0, 1, 1", shape = box]
    3 [label = "2, 1, 1", shape = box, color = DimGray]
    4 [label = "1, 2, 0", shape = box]
  }
  I0 -> 0
