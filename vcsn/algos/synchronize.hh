  ...
  namespace detail
  {
    ...
    struct worded_automaton
    {
      ...
      struct worded_labelset<tupleset<LabelSet...>>
      {
        ...
        using index_t = std::make_index_sequence<labelset_t::size()>;
    ...
    public:
      ...
      std::ostream&
      print_state_name(state_t s, std::ostream& o, format fmt = {})
      {
        auto name = origins().at(s);
        aut_->print_state_name(name.first, o, fmt.delimit(true));
        o << ':';
