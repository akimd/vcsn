...
namespace vcsn
{
  ...
  namespace detail
  {
    ...
    /// Returns corresponding to the predecessor of the state with the
    /// state number corresponding to the index.
    ...
    struct a_star_impl
    {
      ...
      struct profile
      {
        ...
        bool operator<(const profile& rhs) const
        {
          ...
          if (astar_.res_[state_] == astar_.aut_->null_state())
            return true;
          else if (astar_.res_[rhs.state_] == astar_.aut_->null_state())
            return false;
          else
        ...
        friend std::ostream& operator<<(std::ostream& o, const profile& p)
        {
          ...
          if (a.res_[p.state_] != a.aut_->null_state())
      ...
      operator()(Heuristic heuristic)
      {
        ...
        return std::vector<state_t>(size);
      }
