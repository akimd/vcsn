    ...
    public:
      ...
      std::enable_if_t<sizeof...(Auts) == 2 && !L> ldivide()
      {
        ...
        while (!aut_->todo_.empty())
          {
            const auto& i = aut_->todo_.front();
            add_ldivide_transitions(aut_->state(i), aut_->state_name(i));
            aut_->todo_.pop();
          }
      }
      ...
      std::enable_if_t<sizeof...(Auts) == 2 && !L> add()
      {
        ...
        while (!aut_->todo_.empty())
          {
            const auto& i = aut_->todo_.front();
            add_add_transitions(aut_->state(i), aut_->state_name(i));
            aut_->todo_.pop();
          }
      }
    ...
    private:
                           ...
                           seq<I...>)
      {
        ...
        (void) swallow
        {
          ...
          // states.
          (std::all_of(p_in + I + 1, end(p_in), [](auto b){ return b; })
